...
public interface DevicesApi {
    ...
    default ResponseEntity<Device> createDevice(@ApiParam(value = "Device object that needs to be created" ,required=true )  @Valid @RequestBody Device body) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"deviceType\" : {    \"orderNumber\" : \"orderNumber\",    \"price\" : 9.301444243932576,    \"supplier\" : {      \"name\" : \"name\",      \"id\" : 7    },    \"objectTypeName\" : \"objectTypeName\",    \"id\" : 5,    \"classification\" : 2,    \"version\" : \"version\",    \"manufacturer\" : \"manufacturer\"  },  \"barcodeNumber\" : \"barcodeNumber\",  \"serialNumber\" : \"serialNumber\",  \"project\" : {    \"name\" : \"name\",    \"id\" : 3  },  \"comment\" : \"comment\",  \"id\" : 0,  \"companyOwner\" : {    \"name\" : \"name\",    \"id\" : 6  },  \"deviceState\" : {    \"name\" : \"name\",    \"id\" : 5  },  \"department\" : {    \"name\" : \"name\",    \"id\" : 1  },  \"inventoryRecord\" : {    \"inventoryState\" : { },    \"id\" : 2  },  \"addDate\" : \"2000-01-23T04:56:07.000+00:00\",  \"defaultLocation\" : \"defaultLocation\"}", Device.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
    ...
    default ResponseEntity<List<Device>> getDevices() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("[ {  \"deviceType\" : {    \"orderNumber\" : \"orderNumber\",    \"price\" : 9.301444243932576,    \"supplier\" : {      \"name\" : \"name\",      \"id\" : 7    },    \"objectTypeName\" : \"objectTypeName\",    \"id\" : 5,    \"classification\" : 2,    \"version\" : \"version\",    \"manufacturer\" : \"manufacturer\"  },  \"barcodeNumber\" : \"barcodeNumber\",  \"serialNumber\" : \"serialNumber\",  \"project\" : {    \"name\" : \"name\",    \"id\" : 3  },  \"comment\" : \"comment\",  \"id\" : 0,  \"companyOwner\" : {    \"name\" : \"name\",    \"id\" : 6  },  \"deviceState\" : {    \"name\" : \"name\",    \"id\" : 5  },  \"department\" : {    \"name\" : \"name\",    \"id\" : 1  },  \"inventoryRecord\" : {    \"inventoryState\" : { },    \"id\" : 2  },  \"addDate\" : \"2000-01-23T04:56:07.000+00:00\",  \"defaultLocation\" : \"defaultLocation\"}, {  \"deviceType\" : {    \"orderNumber\" : \"orderNumber\",    \"price\" : 9.301444243932576,    \"supplier\" : {      \"name\" : \"name\",      \"id\" : 7    },    \"objectTypeName\" : \"objectTypeName\",    \"id\" : 5,    \"classification\" : 2,    \"version\" : \"version\",    \"manufacturer\" : \"manufacturer\"  },  \"barcodeNumber\" : \"barcodeNumber\",  \"serialNumber\" : \"serialNumber\",  \"project\" : {    \"name\" : \"name\",    \"id\" : 3  },  \"comment\" : \"comment\",  \"id\" : 0,  \"companyOwner\" : {    \"name\" : \"name\",    \"id\" : 6  },  \"deviceState\" : {    \"name\" : \"name\",    \"id\" : 5  },  \"department\" : {    \"name\" : \"name\",    \"id\" : 1  },  \"inventoryRecord\" : {    \"inventoryState\" : { },    \"id\" : 2  },  \"addDate\" : \"2000-01-23T04:56:07.000+00:00\",  \"defaultLocation\" : \"defaultLocation\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
    ...
    @ApiOperation(value = "Updates Device's (deviceId) holder to holderScdId", nickname = "updateDeviceHolder", notes = "", response = Device.class, tags={ "Device", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Updated device with new holder", response = Device.class) })
    @RequestMapping(value = "/devices/{deviceId}/holder/{holderScdId}",
        produces = { "application/json" }, 
        method = RequestMethod.PUT)
    default ResponseEntity<Device> updateDeviceHolder(@ApiParam(value = "Device id to be updated",required=true) @PathVariable("deviceId") Long deviceId,@ApiParam(value = "New holder",required=true) @PathVariable("holderScdId") Long holderScdId) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"deviceType\" : {    \"orderNumber\" : \"orderNumber\",    \"price\" : 9.301444243932576,    \"supplier\" : {      \"name\" : \"name\",      \"id\" : 7    },    \"objectTypeName\" : \"objectTypeName\",    \"id\" : 5,    \"classification\" : 2,    \"version\" : \"version\",    \"manufacturer\" : \"manufacturer\"  },  \"barcodeNumber\" : \"barcodeNumber\",  \"serialNumber\" : \"serialNumber\",  \"project\" : {    \"name\" : \"name\",    \"id\" : 3  },  \"comment\" : \"comment\",  \"id\" : 0,  \"companyOwner\" : {    \"name\" : \"name\",    \"id\" : 6  },  \"deviceState\" : {    \"name\" : \"name\",    \"id\" : 5  },  \"department\" : {    \"name\" : \"name\",    \"id\" : 1  },  \"inventoryRecord\" : {    \"inventoryState\" : { },    \"id\" : 2  },  \"addDate\" : \"2000-01-23T04:56:07.000+00:00\",  \"defaultLocation\" : \"defaultLocation\"}", Device.class), HttpStatus.NOT_IMPLEMENTED);
