...
import cz.siemens.inventory.mapper.CompanyOwnerMapperImpl;
...
public class CompanyOwnerFacadeTest {
	...
	private cz.siemens.inventory.api.gen.model.CompanyOwner expectedCompanyOwnerExternal = getExternalCompanyOwner(1L, "Company Owner");
	...
	public void getCompanyOwners_returnsList() {
		List<cz.siemens.inventory.api.gen.model.CompanyOwner> companyOwners = cut.getCompanyOwners();
	...
	public void getCompanyOwner_byId_returnsOwner() {
		Optional<cz.siemens.inventory.api.gen.model.CompanyOwner> optionalCompanyOwner = cut.getCompanyOwner(1L);
	...
	public void createCompanyOwner_createsOwner() {
		...
		cz.siemens.inventory.api.gen.model.CompanyOwner createdCompanyOwner = cut.createCompanyOwner(companyOwnerMapper.mapToExternal(expectedCompanyOwner));
	...
	public void updateCompanyOwner_updatesOwner() {
		...
		cz.siemens.inventory.api.gen.model.CompanyOwner updatedCompanyOwner = cut.updateCompanyOwner(
	...
	private cz.siemens.inventory.api.gen.model.CompanyOwner getExternalCompanyOwner(Long id, String name) {
		return new cz.siemens.inventory.api.gen.model.CompanyOwner().id(id).name(name);
	}
}
