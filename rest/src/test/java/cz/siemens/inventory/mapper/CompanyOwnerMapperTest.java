...
public class CompanyOwnerMapperTest {
	...
	public void test_nullCompanyOwner_mapToInternal() {
		cz.siemens.inventory.api.gen.model.CompanyOwner nullCompanyOwner = null;
	...
	public void test_CompanyOwner_mapToInternal() {
		cz.siemens.inventory.api.gen.model.CompanyOwner expectedCompanyOwner = getCompanyOwner(1L, "Company owner");
	...
	public void test_CompanyOwnerList_mapToInternal() {
		List<cz.siemens.inventory.api.gen.model.CompanyOwner> expectedCompanyOwners = new ArrayList<>();
	...
	private cz.siemens.inventory.api.gen.model.CompanyOwner getCompanyOwner(Long id, String name) {
		return new cz.siemens.inventory.api.gen.model.CompanyOwner().id(id).name(name);
	}

	private void assertThatCompanyOwnersAreEqual(CompanyOwner actualCompanyOwner, cz.siemens.inventory.api.gen.model.CompanyOwner expectedCompanyOwner) {
